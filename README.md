...
The repository can also be built on Linux with CMake.

Verified on a machine with:
- CMake 3.28
- GCC 13
- CUDA 13.0
- NVIDIA RTX 3090 (`CMAKE_CUDA_ARCHITECTURES=86`)
- OpenCV 4
- FFmpeg
- Assimp
- Embree 4
...
After installation, the main binaries are available in `install/bin`, including:
...
For a trained 3D Gaussian Splatting model:
...
Headless validation mode is also supported:
